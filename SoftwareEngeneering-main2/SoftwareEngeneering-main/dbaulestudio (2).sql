...
--
-- Host: 127.0.0.1
-- Creato il: Feb 10, 2025 alle 23:35
...
CREATE TABLE `aula` (
  ...
  `nome` varchar(32) NOT NULL,
  `numerotavoli` int(11) NOT NULL,
  `numeropostazioni` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `aula` (`id`, `fkedificio`, `nome`, `numerotavoli`, `numeropostazioni`) VALUES
(1, 1, 'prova3', 0, 0),
(2, 7, 'prova2', 0, 0);
...
INSERT INTO `edificio` (`id`, `nome`) VALUES
(1, 'Edificio 1'),
(2, 'Edificio 2'),
(3, 'Edificio 3'),
(4, 'Edificio 4'),
...
INSERT INTO `materia` (`id`, `materia`, `fkcorsodistudio`) VALUES
...
INSERT INTO `prenotazione` (`id`, `fkstudente`, `fktavolo`, `orainizio`, `orafine`, `fkmateria`) VALUES
(1, 1, 1, '2025-02-12 08:00:00', '2025-02-12 12:00:00', 10);
...
INSERT INTO `tavolo` (`id`, `numeroposti`, `fkaula`) VALUES
(1, 4, 1);
